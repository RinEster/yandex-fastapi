...
def update_user_login_use_case() -> UpdateUserLoginUseCase:
    return UpdateUserLoginUseCase()

def update_user_email_use_case() -> UpdateUserEmailUseCase:
    return UpdateUserEmailUseCase()

def update_user_password_use_case() -> UpdateUserPasswordUseCase:
    return UpdateUserPasswordUseCase()

def update_user_name_use_case() -> UpdateUserNameUseCase:
